<script setup>
  ...
  watch(weights, newWeights => {
          ...
          datasets: [
            {
              ...
              backgroundColor: "rgba(40, 143, 247, 0.2)",
              borderColor: "rgb(40, 143, 247)",
              borderWidth: 1,
              fill: true
            }
          ]
    ...
    console.log(ws.sort((a,b) => a.date - b.date).map(w => new Date(w.date).toLocaleDateString()));
  }, {deep: true})
...
.current {
	...
	border: 5px solid rgb(40, 143, 247);
...
form input[type="submit"]:hover {
	...
	border-left-color: rgb(40, 143, 247);
}
